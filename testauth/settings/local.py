...
# eve_sde is required by wanderer.MapStructure/Structure's solar_system FK.
INSTALLED_APPS += ["eve_sde", "wanderer"]
...
# to https://example.com/sso/callback substituting your domain for wanderer.com
...
# Set the default from email to something like 'noreply@wanderer.com'
